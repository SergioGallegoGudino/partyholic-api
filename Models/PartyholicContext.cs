...
public partial class PartyholicContext : DbContext
{
    ...
    public virtual DbSet<GruposLogro> GruposLogros { get; set; }

    public virtual DbSet<Logro> Logros { get; set; }

    public virtual DbSet<Mensaje> Mensajes { get; set; }

    public virtual DbSet<Retar> Retars { get; set; }

    public virtual DbSet<Usuario> Usuarios { get; set; }

    public virtual DbSet<UsuariosEvento> UsuariosEventos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Evento>(entity =>
        {
            ...
            entity.HasOne(d => d.CodGrupoNavigation).WithMany(p => p.Eventos)
        ...
        {
            entity.HasKey(e => e.CodGrupo).HasName("PRIMARY");
        ...
        modelBuilder.Entity<GruposLogro>(entity =>
        {
            ...
            entity.HasOne(d => d.CodGrupoNavigation).WithMany(p => p.GruposLogros)
                .HasForeignKey(d => d.CodGrupo)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("GruposLogros_ibfk_1");

            entity.HasOne(d => d.CodLogroNavigation).WithMany(p => p.GruposLogros)
        ...
        {
            entity.HasKey(e => e.CodLogro).HasName("PRIMARY");
        ...
        modelBuilder.Entity<Mensaje>(entity =>
        {
            ...
            entity.HasOne(d => d.CodGrupoNavigation).WithMany(p => p.Mensajes)
                .HasForeignKey(d => d.CodGrupo)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("Mensajes_ibfk_2");

            entity.HasOne(d => d.UsernameNavigation).WithMany(p => p.Mensajes)
        ...
        modelBuilder.Entity<Retar>(entity =>
        {
            ...
            entity.HasOne(d => d.GrupoRetadoNavigation).WithMany(p => p.RetarGrupoRetadoNavigations)
                .HasForeignKey(d => d.GrupoRetado)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("Retar_ibfk_2");

            entity.HasOne(d => d.GrupoRetadorNavigation).WithMany(p => p.RetarGrupoRetadorNavigations)
        ...
        modelBuilder.Entity<UsuariosEvento>(entity =>
        {
            ...
            entity.HasOne(d => d.UsernameNavigation).WithMany(p => p.UsuariosEventos)
                .HasForeignKey(d => d.Username)
                .OnDelete(DeleteBehavior.Cascade)
        ...
        modelBuilder.Entity<UsuariosGrupo>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.CodGrupo).HasColumnName("cod_grupo");
            entity.Property(e => e.RolGrupo)
                .HasMaxLength(100)
                .HasColumnName("rol_grupo");
            entity.Property(e => e.Username)
                .HasMaxLength(100)
                .HasColumnName("username");

            entity.HasOne(d => d.CodGrupoNavigation).WithMany(p => p.UsuariosGrupos)
                .HasForeignKey(d => d.CodGrupo)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("UsuariosGrupos_ibfk_1");

            entity.HasOne(d => d.UsernameNavigation).WithMany(p => p.UsuariosGrupos)
                .HasForeignKey(d => d.Username)
                .OnDelete(DeleteBehavior.Cascade)
